# agent-docs docs router

Start here, then read only the smallest matching subtree.
...
| Active and shipped plans | [`plans/index.md`](plans/index.md) |
| Ownership and drift gates | [`_meta/manifest.md`](_meta/manifest.md), [`_meta/ownership.json`](_meta/ownership.json) |
